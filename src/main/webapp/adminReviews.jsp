							...
							<table class="table">
								...
								<tbody>
									...
									<c:forEach var="item" items="${list}">
										<c:set var="user"
											value="${userFactory.getUserByIdProductDetail(item.orderDetailId)}" />
										<tr class="table__row">
											...
											<fmt:formatDate var="dateReview" pattern="dd-MM-yyyy"
	...
	<div id="dialog-review-read" class="modal">
		<article class="modal__content modal__product">
			<div>
				...
				<i
					class="modal__product-close  modal__review-close fa-solid fa-xmark"></i>
			</div>
			<iframe class="modal__product-iframe" src="adminReviewForm.jsp"
