                                ...
                                <div class="contact_us row">
                                    <div class="contact__container col">
                                        <div class="contact__content">
                                            ...
                                            <p class="subtitle__contact">Bạn có muốn liên lạc với chúng tôi? Nếu có thì
                                                bạn hãy điền đầy đủ
                                                thông tin vào form và chúng tôi sẽ cố gắng phản hồi sớm nhất trong vòng
                                                24h. Hoặc bạn có thể
                                            ...
                                            <div class="form__block">
                                                <label for="fullName" class="form__label">Họ và tên <span
                                                        class="compulsory__mark">*</span></label>
                                                <input class="form__input" type="text" id="fullName" name="fullName"
                                                    placeholder="Họ và tên của bạn" value="<c:if test="
                                                    ${requestScope.fullName !=null}">${requestScope.fullName}</c:if>">
                                                <span id="fullNameError" class="error-notice"></span>
                                            </div>
                                            <div class="form__block">
                                                <label for="phone" class="form__label">Số điện thoại <span
                                                        class="compulsory__mark">*</span></label>
                                                <input class="form__input" type="text" id="phone" name="phone"
                                                    placeholder="Số điện thoại của bạn" value="<c:if test="
                                                    ${requestScope.phone !=null}">${requestScope.phone}</c:if>">
                                            ...
                                            <div class="form__block">
                                                ...
                                                <input class="form__input" type="text" id="email" name="email"
                                                    placeholder="Email của bạn" value="<c:if test=" ${requestScope.email
                                                    !=null}">${requestScope.email}</c:if>">
                                            ...
                                            <div class="form__block">
                                                ...
                                                <select class="select__box" name="subject" id="subject">
                                                    <c:forEach items="${requestScope.listContactSubjects}"
                                                        var="subjectOption">
                                                        <option value="${subjectOption.subjectName}" <c:if
                                                            test="${subjectOption.subjectName eq requestScope.subject}">
                                                            selected </c:if>
                                            ...
                                            <div class="form__block">
                                                <label for="message" class="form__label">Chúng tôi có thể giúp gì được
                                                    cho bạn?</label>
