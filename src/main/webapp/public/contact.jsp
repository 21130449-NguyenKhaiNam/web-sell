                    ...
                    <div class="contact__container col">
                        <div class="contact__content"><h2 class="title__contact">Liên hệ</h2>
                            ...
                            <form method="post" action="<c:url value="/Contact"/>" id="contact__form">
                                <div class="form__block"><label for="fullName" class="form__label">Họ và tên
                                ...
                                <div class="form__block"><label for="phone" class="form__label">Số điện thoại
                                    <span class="compulsory__mark">*</span>
                                </label>
                                ...
                                <div class="form__block"><label for="email" class="form__label">Email
                                    <span class="compulsory__mark">*</span>
                                </label>
                                ...
                                <div class="form__block"><label for="subject" class="form__label">Chủ đề
                                    ...
                                    <select class="select__box" name="subject" id="subject">
                                        <c:forEach items="${requestScope.listContactSubjects}" var="subjectOption">
                                            <option value="${subjectOption.subjectName}"
                                                    <c:if test="${subjectOption.subjectName eq requestScope.subject}"> selected </c:if> class="option">${subjectOption.subjectName}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                                <div class="form__block"><label for="message" class="form__label">Chúng tôi có thể giúp
                                    gì được cho bạn?</label>
