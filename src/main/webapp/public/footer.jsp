                ...
                <div class="row">
                    <div class="col ">
                        ...
                        <div class="footer__block">
                            ...
                            <a target="_blank" href="https://maps.app.goo.gl/RETcqrjaKeqTCfBE6" class="footer__desc">721
                                Huỳnh
                                Tấn Phát,
                                Phường
                    ...
                    <div class="col">
                        <ul class="footer__block">
                            <li class="footer__desc hvr-sweep-to-right">
                                <a href="${initParam.contextPath}/public/product/productBuying.jsp"
                                    class="footer__link">Gian hàng</a>
                            </li>
                            <li class="footer__desc hvr-sweep-to-right">
                                <a href="${initParam.contextPath}/public/contact.jsp" class="footer__link">Liên hệ</a>
                            </li>
                            <li class="footer__desc hvr-sweep-to-right">
                                <a href="${initParam.contextPath}/public/about.jsp" class="footer__link">Về chúng
                                    tôi</a>
                            </li>
                            <li class="footer__desc hvr-sweep-to-right">
                                <a href="${initParam.contextPath}/public/policy.jsp" class="footer__link">Chính sách mua
                                    hàng</a>
                            </li>
                        </ul>
                    </div>
