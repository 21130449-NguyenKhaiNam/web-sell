                        ...
                        <div class="container-xl">
                            <div class="nav__inner">
                                ...
                                <ul class="nav__list">
                                    ...
                                    <li class="nav__item">
                                        <a href="<c:url value=" /public/product/productBuying.jsp" />" class="nav__link
                                        hvr-grow-shadow">Gian
                                        hàng</a>
                                    </li>
                                    <li class="nav__item">
                                        <a href="<c:url value=" /public/contact.jsp" />" class="nav__link
                                        hvr-grow-shadow">Liên hệ</a>
                                    </li>
                                    <li class="nav__item">
                                        <a href="<c:url value=" /public/about.jsp" />" class="nav__link
                                        hvr-grow-shadow">Về chúng tôi</a>
                                    </li>
                                </ul>
                                ...
                                <%-- log: ${auth}--%>
                                    <c:choose>
                                        <c:when test="${auth == null}">
                                            <!--cta == call to action-->
                                            <div class="nav__cta">
                                                <a href="<c:url value=" /public/auth/signIn.jsp" />" class="me-3
                                                nav__button nav__button--signIn hvr-ripple-in">Đăng
                                                nhập</a>
                                                <a href="<c:url value=" /public/auth/signUp.jsp" />"
                                                class="nav__button nav__button--signUp button button button--hover
                                                hvr-round-corners hvr-radial-out">Đăng ký</a>
                                            </div>
                                        </c:when>
                                        <c:otherwise>
                                            ...
                                            <div class="account__wrapper">
                                                ...
                                                <div class="cart__wrapper">
                                                    ...
                                                    class="cart">
                                                    <span class="cart__content"><i
                                                            class="cart__icon fa-solid fa-cart-shopping"></i> Giỏ
                                                        hàng</span>
