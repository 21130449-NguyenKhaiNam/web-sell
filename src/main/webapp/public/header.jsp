        ...
        <div class="container-xl">
            <div class="nav__inner">
                ...
                <ul class="nav__list">
                    ...
                    <li class="nav__item">
                        <a href="${pageContext.request.contextPath}/public/about.jsp" class="nav__link hvr-grow-shadow"> Về
                            chúng tôi
                        </a>
                    </li>
                </ul>
                ...
                <c:choose>
                    <c:when test="${empty auth}"> <!--cta == call to action-->
                        <div class="nav__cta">
                            <a href="${pageContext.request.contextPath}/public/auth/signIn.jsp"
                    ...
                    <c:otherwise> <!--Account show (After log in success)-->
                        <div class="account__wrapper">
                            ...
                            <div class="cart__wrapper">
                                <a href="${pageContext.request.contextPath}/public/user/shoppingCart.jsp" class="cart">
                            ...
                            <div class="account hvr-grow">
                                ...
                                <div class="setting__list">
                                    ...
                                    <a href="${pageContext.request.contextPath}/signOut" class="setting__item">
