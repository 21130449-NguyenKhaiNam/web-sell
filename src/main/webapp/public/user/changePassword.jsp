                                    ...
                                    <div class="col-3">
                                        <div class="service__list">
                                            <a class="service__item hvr-shutter-in-vertical" href="<c:url value="
                                                /Account" />" >Chỉnh sửa tài khoảng</a>
                                        ...
                                        <section class="service__section service__section--show">
                                            ...
                                            <div class="form contains">
                                                <div class="info__oldPass info-compo">
                                                    <label class="lable__oldPass lable-compo" for="oldPassword">Mật khẩu
                                                        cũ</label>
                                                    <div class="input__form">
                                                        <input class="input__oldPass input-compo" type="password"
                                                            id="oldPassword" name="oldPassword">
                                                        <i
                                                            class=" icon__eye icon__eye--close fa-regular fa-eye-slash"></i>
                                                ...
                                                <div class="info__newPass info-compo">
                                                    <label class="lable__newPass lable-compo" for="password">Mật khẩu
                                                        mới</label>
                                                    <div class="input__form">
                                                ...
                                                <div class="info__newPass--confirm info-compo">
                                                    <label class="lable__newPass--confirm lable-compo"
                                                        for="confirm-password">Nhập lại mật khẩu
                                                        mới</label>
                                                    <div class="input__form">
                                                ...
                                                <div class="save save__changePass">
                                                    <button id="form__submit" type="submit"
                                                        class=" form__submit button button--hover">Lưu thay
                                                        đổi
                                                    </button>
                                                </div>
                                            </div>
