                            ...
                            <div class="row">
                                <div class="col-3">
                                    <div class="service__list">
                                        <a class="service__item hvr-shutter-in-vertical" href="<c:url value="
                                            /Account" />">Chỉnh sửa tài khoản</a>
                                        <a class="service__item hvr-shutter-in-vertical" href="<c:url value="
                                            /ChangePassword" />">Đổi mật khẩu</a>
                                ...
                                <div class="col-9">
                                    <section class="service__section service__section--show">
                                        ...
                                        <div class="statusOrder">
                                            <a class="${tag==" TẤT CẢ"?"status__list
                                                status__list--click":"status__list"}" href="<c:url value="
                                                /PurchaseHistory?status=TẤT CẢ" />">Tất cả</a>
                                        ...
                                        <div id="serviceOrderContainer" class="service__order service__order--show">
                                            <c:set var="listPurchaseHistory"
                                                value="${requestScope.listPurchaseHistory}" />
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    <c:forEach items="${listPurchaseHistory}" var="item">
                                                        <c:set var="product"
                                                            value="${productFactory.getProductById(item.productId)}" />
                                                        <div class="block__product">
                                                            <c:set var="image"
                                                            ...
                                                            <div class="block__info">
                                                                <p class="info__product info__product--name">
                                                                    ${product.name}</p>
                                                                <p class="info__product">Phân
                                                                    loại:
                                                                    ${productFactory.getNameCategoryById(product.categoryId)}
                                                                </p>
                                                                <p class="info__product">Số lượng:
                                                                    ${item.getQuantityRequired()}</p>
                                                                <fmt:formatNumber
                                                                    value="${item.getQuantityRequired() * item.getPrice()}"
                                                                    type="currency" currencyCode="VND" var="price" />
                                                                <p class="info__product">Giá: ${price}</p>
                                                            </div>
                                                            <c:if
                                                                test="${requestScope.tag eq '4' and requestScope.OrderDetailNotReview != null}">
