                                ...
                                <div class="col-6">
                                    <article class="product">
                                        <div class="product__img">
                                            <img src="<c:url value="
                                                /assets/img/product_img/${productFactory.getListImagesByProductId(productId).get(0).nameImage}" />"
                                        ...
                                        <div class="product__info">
                                            ...
                                            <p class="product__category">Phân loại:
                                                ${productFactory.getNameCategoryById(productId)}</p>
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${loop.index ==1}">
                                                                <label class="review__star review__star--choose">
                                                                    <input type="radio" name="ratingStar" checked
                                                                        hidden="hidden" value="${loop.index}">
                                                                </label>
                                                            </c:when>
                                                            <c:otherwise>
