                            ...
                            <div class="checkout__container row">
                                <div class="checkout__info--left col">
                                    <div class="delivery__info--container">
                                        ...
                                        <form id="delivery__info--form">
                                            ...
                                            <c:if test="${sessionScope.deliveryInfoStorage != null}">
                                                <c:forEach
                                                    items="${sessionScope.deliveryInfoStorage.deliveryInfoMap.keySet()}"
                                                    var="deliveryInfoKey">
                                                    <div <c:if test="${deliveryInfoKey eq 'defaultDeliveryInfo'}">
                                                        id="default__info"
                                            </c:if>
                                            ...
                                            <ul class="info__items">
                                                <li class="info__item customer__name">${deliveryInfo.fullName}<c:if
                                                        test="${deliveryInfoKey eq 'defaultDeliveryInfo'}"><span
                                    ...
                                    <p class="other__info">Bạn muốn giao hàng đến địa chỉ khác?
                                        <span onclick="showCustomizeDeliveryInfoForm(this, 'Thêm thông tin giao hàng')"
                                            class="add__delivery">Thêm thông tin giao hàng mới</span>
                                    </p>
                                    <div class="popup__bg">
                                            ...
                                            <form id="customize__info--form">
                                                ...
                                                <div class="customize__item">
                                                    ...
                                                    <input type="text" name="fullName"
                                                        class="input__content field__content" id="fullName"
                                                ...
                                                <div class="customize__item">
                                                    ...
                                                    <input type="text" name="email"
                                                        class="input__content field__content" id="email"
                                                ...
                                                <div class="customize__item">
                                                    ...
                                                    <input type="text" name="phone"
                                                        class="input__content field__content" id="phone"
                                                ...
                                                <div class="customize__item">
                                                    <label for="address" class="input__text">Địa chỉ <span
                                                            class="compulsory">*</span></label>
                                                    <textarea class="textarea__content field__content" name="address"
                                                        id="address" rows="6" placeholder="Địa chỉ của bạn"></textarea>
                                ...
                                <c:choose>
                                    <c:when test="${sessionScope[userIdCart].getTotalPrice(false) >= freeShip}">
                                        <p class="free__ship"><i class="fa-solid fa-circle-check"></i>Miễn phí vận
                                            chuyển cho hóa đơn từ
                                            <fmt:setLocale value="vi_VN" />
                                            <fmt:formatNumber value="${freeShip}" type="currency" />
                                        </p>
                                    </c:when>
                                    <c:otherwise>
                                        <div class="delivery__method--container">
                                            ...
                                            <form id="delivery__method--form" class="radio__section">
                                                ...
                                                <c:forEach items="${requestScope.listDeliveryMethod}"
                                                    var="deliveryMethod">
                                                    <div class="method__content">
                                                        <div class="method__item section__info--selection">
                                                            <input <c:if
                                                                test="${deliveryMethod eq sessionScope[userIdCart].deliveryMethod}">checked
                                                            </c:if>
                                                            ...
                                                            <label class="label__selection"
                                                                for="delivery__method${deliveryMethod.id}">
                                    ...
                                    <form id="payment__method--form" class="radio__section">
                                        ...
                                        <c:forEach items="${requestScope.listPaymentMethod}" var="paymentMethod">
                                            <div class="method__content">
                                                <div class="method__item section__info--selection">
                                                    <input <c:if
                                                        test="${paymentMethod eq sessionScope[userIdCart].paymentMethod}">checked
                                                    </c:if>
                                                ...
                                                <div class="description__method information__transaction">
                                                    <c:choose>
                                                        <c:when test="${paymentMethod.id > 1}">
                                                            <c:set
                                                                value="${CheckoutServices.getINSTANCE().getPaymentOwnerByPaymentMethodId(paymentMethod.id)}"
                                                                var="paymentOwner" />
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr class="amount__pay">
                                                                        ...
                                                                        <td>
                                                                            <div>
                                                                                <span
                                                                                    class="amount">${sessionScope[userIdCart].totalPriceFormat(true)}</span>
                                                                                <span class="copy__button"><i
                                                                                        class="fa-solid fa-copy"></i>
                                                                                    Sao chép</span>
                                                                            </div>
                                                                    ...
                                                                    <tr class="transaction__content">
                                                                        ...
                                                                        <td>
                                                                            <div>
                                                                                <span
                                                                                    class="content">${sessionScope.contentForPay}</span>
                                                                                <span class="copy__button"><i
                                                                                        class="fa-solid fa-copy"></i>
                                                                                    Sao chép</span>
                                                                            </div>
                                                            ...
                                                            <div class="payment__qr">
                                                                <img class="qr__code"
                                                                    src="assets/img/paymentQR/${qrImage}">
                                                                <div>
                                                                    <span>Hoặc bạn có thể quét QR code bên cạnh để tiến
                                                                        hành thanh toán một cách nhanh chóng và chính
                                                                        xác hơn</span>
                                                                    <span><strong style="font-weight: 500">* Lưu
                                                                            ý:</strong> Trước khi thanh toán vui lòng
                                                        ...
                                                        <c:otherwise>
                                                            <span class="cod">Khi chọn phương thức trả tiền mặt khi nhận
                                                                hàng (COD), vui lòng bạn chuẩn bị đầy đủ số tiền cần
                                                                thanh toán cho nhà vận chuyển khi nhận hàng</span>
                                                        </c:otherwise>
                                                    </c:choose>
                                                </div>
                                            </div>
                                    ...
                                    <table class="order__table">
                                        ...
                                        <tbody>
                                            <c:forEach items="${sessionScope[userIdCart].shoppingCartMap.keySet()}"
                                                var="productId">
                                                <c:forEach
                                                    items="${sessionScope[userIdCart].shoppingCartMap.get(productId)}"
                                                    var="cartProduct">
                                                    <tr class="row__content">
                                                        <td class="td__item">
                                                            <div class="product__item">
                                                                ...
                                                                <img
                                                                    src='assets/img/product_img/${listImagesProduct.get(0).nameImage}'>
                                                                <div class="order__product--info">
                                                                    <p class="product__name">${cartProduct.product.name}
                                                                    </p>
                                                                    <p class="order__color">Màu sắc:
                                                                        ${cartProduct.color.codeColor}</p>
                                                                    <p class="order__size">
                                                                        ${cartProduct.makeSizeFormat()}</p>
                                                                </div>
                                                            </div>
                                                        </td>
                                ...
                                <div class="invoice--final">
                                    <div class="invoice__content">
                                            ...
                                            <c:if test="${sessionScope[userIdCart].deliveryMethod != null}">
                                                <div class="shipping__container">
                                                    ...
                                                    <span>
                                                        <fmt:setLocale value="vi_VN" />
                                                        <fmt:formatNumber type="currency"
                                                            value="${sessionScope[userIdCart].deliveryMethod.shippingFee}" />
                                                    </span>
                                                </div>
                                            </c:if>
                                        </div>
                                        <div class="total__price--final">
                                            ...
                                            <span
                                                class="total__value">${sessionScope[userIdCart].totalPriceFormat(true)}</span>
                                        </div>
                                    </div>
