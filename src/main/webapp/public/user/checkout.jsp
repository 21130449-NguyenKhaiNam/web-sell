                ...
                <div class="delivery__info--container">
                                ...
                                <div
                                    ...
                                    <div class="info__header">
                                        ...
                                        <span class="edit__delivery"
                                              onclick="showCustomizeDeliveryInfoForm(this, 'Chỉnh sửa thông tin giao hàng')">Chỉnh sửa</span>
                                    </div>
                                    <ul class="info__items">
                                        <li class="info__item customer__name">${deliveryInfo.fullName}<c:if
                                                ...
                                                class="default__tag">Mặc định</span></c:if></li>
                    ...
                    <p class="other__info">Bạn muốn giao hàng đến địa chỉ khác?
                        <span onclick="showCustomizeDeliveryInfoForm(this, 'Thêm thông tin giao hàng')"
                              class="add__delivery">Thêm thông tin giao hàng mới</span></p>
                    <div class="popup__bg">
