...
<div class="container">
    ...
    <p class="guide__next">Để kiểm tra tất cả chi tiết về đơn hàng đã đặt vui lòng chọn "Chi tiết đơn hàng" hoặc xem
        trong email thông tin mua hàng và để khám phá thêm các sản phẩm khác vui lòng chọn "Tiếp tục mua sắm" </p>
