        ...
        <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            ...
            <body>
                ...
                <div class="container">
                    ...
                    <p class="guide__next">Để kiểm tra tất cả chi tiết về đơn hàng đã đặt vui lòng chọn "Chi tiết đơn
                        hàng" hoặc xem
                        trong email thông tin mua hàng và để khám phá thêm các sản phẩm khác vui lòng chọn "Tiếp tục mua
                        sắm" </p>
                    ...
                    <p class="back__home">Website sẽ tự động quay về trang chủ sau <span
                            class="countdown__second"></span></p>
                </div>
