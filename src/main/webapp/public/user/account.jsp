                                ...
                                <div class="row">
                                    <div class="col-3">
                                        <div class="service__list">
                                            ...
                                            <a class="service__item hvr-shutter-in-vertical" href="<c:url value="
                                                /PurchaseHistory" />">Lịch sử mua hàng</a>
                                        </div>
                                    </div>
                                    <div class="col-9">
                                        <section class="service__section service__section--show">
                                            ...
                                            <div class="user__maininfo block_info">
                                                <div class="user__img user">
                                                    ...
                                                    <img id="photo" src="<c:url value="
                                                        /assets/img/user/userDefaultAvatar.jpg" />">

                                                    <form id="uploadForm" action="<c:url value=" /UploadAvatar" />"
                                                ...
                                                <div class="user__info user">
                                                    ...
                                                    <div class="user__info--name info-compo">
                                                        ...
                                                        <input type="text" id="Username" class=" input-compo"
                                                            name="userName" value="${accountInfo.username}">
                                                    </div>
                                                    ...
                                                    <div class="user__info--name info-compo">
                                                        ...
                                                        <input type="text" id="FullName" class=" input-compo"
                                                            name="fullName" value="${accountInfo.fullName}">
                                                    </div>
                                                    <div class="user__info--email info-compo">
                                                        <div class="lable__email lable-compo">
                                                            <label for="Email">Số điện thoại</label>
                                                        </div>
                                                        <input type="number" id="Phone" class=" input-compo"
                                                            name="phone" value="${accountInfo.phone}">
                                                    </div>
                                                        ...
                                                        <div class="gender__option">
                                                            <select id="gender" name="gender"
                                                                ...
                                                                <c:choose>
                                                                    ...
                                                                    <c:otherwise>
                                                                        <option value="" id="defaultOption">-- Chọn giới
                                                                            tính --</option>
                                                    ...
                                                    <div class="user__info--birthday info-compo">
                                                        ...
                                                        <div class="birthday__option">
                                                            <select type="text" class="input-compo" id="year"
                                                                name="year">
                                                    ...
                                                    <div class="user__info--address info-compo">
                                                        ...
                                                        <input type="text" class="input-compo" id="Address"
                                                            name="address" value="<c:out value="
                                                            ${accountInfo.address}" />">
                                                    </div>
