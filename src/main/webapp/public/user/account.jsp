                ...
                <section class="service__section service__section--show">
                    ...
                    <div class="user__maininfo block_info">
                        <div class="user__img user">
                            ...
                            <form id="uploadForm" action="<c:url value="/UploadAvatar"/>" method="post"
                        ...
                        <form action="<c:url value="/UpdateAccount"/>" method="post" enctype="multipart/form-data"
                            ...
                            <div class="user__info user">
                                <input type="hidden" name="userId" value="<c:out value='${auth.getId()}'/>">
                                <div class="user__info--name info-compo mb-4">
                                    <div class="lable__name lable-compo">
                                        <label for="Username">Tên người dùng</label>
                                    </div>
                                ...
                                <div class="user__info--email info-compo mb-4">
                                    <div class="lable__phone lable-compo">
                                        <label for="Phone">Số điện thoại</label>
                                    </div>
                                    <input type="text" id="Phone" class=" input-compo" name="phone"
                                           value="${accountInfo.phone}">
                                    <c:set value="${requestScope.phoneError}" var="phoneError"/>
                                    <p class="form__error">
                                        <c:if test="${phoneError != null}">${phoneError}</c:if>
                                    </p>
                                </div>
                                <div class="user__info--gender info-compo mb-4">
                                    <div class="lable__gender lable-compo">
                                        <label for="gender">Giới tính</label>
                                    </div>
                                    <div class="gender__option">
                                ...
                                <div class="user__info--birthday info-compo mb-4">
                                    <div class="lable__birthday lable-compo">
                                        <label for="day">Ngày sinh</label>
                                    </div>
                                    <div class="birthday__option">
                                ...
                                <div class="user__info--address info-compo mb-4">
                                    <div class="lable__address lable-compo">
                                        <label for="Address">Địa chỉ</label>
                                    </div>
...
<script>
    var validation = new Validation({
        formSelector: ".form__updateAccount",
