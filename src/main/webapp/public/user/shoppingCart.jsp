                ...
                <c:otherwise>
                                            ...
                                            <a class="product__image"
                                               href="<c:url value="
                                                                                                                            ...
                                                                                                                            <%=productId%>
                                                                                                                                ">
                                                <img
                                                        src='<%=CloudinaryUploadServices.getINSTANCE().getImage("product_img", ProductFactory.getListImagesByProductId(productId).get(0).getNameImage())%>'>
                                            </a>
                                            <div
                    ...
                    <div
                            ...
                            <div
                                ...
                                <ul
                                    ...
                                    <li
                                            class="price__item">
                                            <%-- <c:if
                                                test="${sessionScope[userIdCart].getDiscountPrice() != 0}">--%>
                                            <%-- <p
                                                class="price__text">--%>
                                            <%-- Giảm
                                                giá
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <p
                                                class="price__value--final">
                                            0 đ
                                        </p>
                                        <p
                                                class="price__value--noted">
                                            (Đã
                                            bao
                                            gồm
                                            VAT
                        ...
                        <span>Phí
                                                                                                    vận toán</span>
                        <div
                                class="group__button--forward">
                            <a id="continue--directional"
                               href="<c:url value="
                                                                                                        /public/user/checkout.jsp" />">
                                <button
                                        id="continue--checkout">Tiến
                                    hành thanh toán
                                </button>
                            </a>
                            <a href="<c:url value="
...
<script src="<c:url value=" /js/shoppingCart.js" />
                                                                    "></script>
