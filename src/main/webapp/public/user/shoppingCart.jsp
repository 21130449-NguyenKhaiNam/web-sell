        ...
        <div class="cart__container row">
            ...
            <div class="cart__content col">
                <form class="shopping__cart--form" action="/ShoppingCart" method="post">
                    <div class="d-flex w-100 check__header">
                        <input type="radio" id="check__pay-all" name="check-high" class="check-high"/>
                        <label for="check__pay-all" class="check__title">Lựa chọn toàn bộ</label>
                    ...
                    <table id="cart__table">
                        ...
                        <%
                            ...
                            Map<Integer, List<AbstractCartProduct>> shoppingCartMap =
                                    ((ShoppingCart) request.getSession().getAttribute(userIdCart)).getShoppingCartMap();
                            for
                            (Integer productId :
                        ...
                        <tr class="cart__item" data-product-id="<%=productId%>"
                            ...
                            <td class="container__check__pay">
                                <input type="checkbox" class="check__pay"/>
                            </td>
                            ...
                            <td>
                                <div class="quality__swapper">
                                    ...
                                    <input type="number" name="quality__required" class="quality__required" min="1"
                    ...
                    <div class="invoice__detail--info">
                        ...
                        <div class="price__total">
                            ...
                            <div class="price__content">
                                <p class="price__value--final"> 0 đ </p>
