                ...
                <article>
                    <form action="<c:url value="/signUp"/>" method="post" class="form form--signUp">
                        ...
                        <div class="form__block">
                            ...
                            <input id="email" name="email" type="email" class="form__input" value="${requestScope.googleUser.email}">
                        ...
                        <div class="form__block">
                            ...
                            <p class="form__error">
                                <c:if test="${passwordError != null}">${passwordConfirmError}</c:if></p>
                        </div>
                        <button type="submit" id="form__submit" class="form__submit button button--hover">Đăng ký
                        </button>
                    </form>
                    <a href="<c:url value="/public/auth/signIn.jsp"/>" id="form__link--signIn" class="form__link ">Đăng
                                                                                                                   nhập
                    </a>
                </article>
            </div>
            ...
            <c:if test="${requestScope.sendMail != null}"> <!--Modal -->
                ...
                <div class="modal">
                    <div class="modal__notify">
                        ...
                        <a href="<c:url value="/public/auth/signIn.jsp"/>" class="button modal__button button--hover">
                            Đăng nhập
                        </a>
