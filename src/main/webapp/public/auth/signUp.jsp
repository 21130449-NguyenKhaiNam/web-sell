                    ...
                    <main class="main">
                        <div class="frame">
                            ...
                            <article>
                                ...
                                <button type="submit" id="form__submit" class="form__submit button button--hover">Đăng
                                    ký
                                </button>
                                </form>
                                <a href="<c:url value=" /public/auth/signIn.jsp" />" id="form__link--signIn"
                                class="form__link hvr-float-shadow">Đăng nhập</a>
                            </article>
                        </div>
                        ...
                        <c:if test="${requestScope.sendMail != null}">
                            ...
                            <div class="modal">
                                <div class="modal__notify">
                                    ...
                                    <p class="modal__text">Đăng kí thành công, vui lòng kiểm tra email bạn đã đăng kí.
                                    </p>
                                    <a href="<c:url value=" /public/auth/signIn.jsp" />" class="button modal__button
                                    button--hover">Đăng nhập</a>
                                    <label for="modal__hide" class="modal__close"><i
