        ...
        <main id="main">
            <div class="new__section container-xl">
                ...
                <div class="pagination">
                    <c:if test="${page > 1}"> <c:url var="prevURLPage" value="newProducts">
                    ...
                    <c:url var="trURLPage" value="newProducts"> <c:param name="page" value="${i}" /> </c:url>
                    <a class="${i == page ? " active" : "page__forward" }" href="${trURLPage}">${i}</a>
                </c:forEach> <c:if test="${page < requestScope.totalPage}">
                    <c:url var="nextURLPage" value="newProducts"> <c:param name="page" value="${page + 1}" /> </c:url>
