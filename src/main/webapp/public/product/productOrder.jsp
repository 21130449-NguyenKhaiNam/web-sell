                            ...
                            <%--So do --%>
                                <div class="col-12">
                                    ...
                                    <div class="order__guide-size">
                                        <img src="<c:url value=" assets/img/size_table/${category.sizeTableImage}" />"
                                        alt="">
                                    </div>
                                </div>
                                <c:forEach var="parameter" items="${listParameter}" varStatus="loop">
                                    <%--Parameter--%>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" name="nameParameter" hidden="hidden"
                                                value="${parameter.name}">
                                            <div class="row align-items-center">
                                                <div class="col-5">
                                                    <label class="order__group">
                                                        <label class="order__parameter">
                                                            <input id="parameter${loop.index}"
                                                                class="order__input form-control" aria-label="Large"
                                                        ...
                                                        <p class="order__parameter-valid ps-2">
                                                            Giá trị khả dụng chấp nhận từ <strong><span
                                                                    id="minValueParameter${loop.index}"
                                                                    class="order__parameter-min">${parameter.minValue}</span>
                                                                ${unit}
                                                            </strong> đến
                                                            <strong><span id="maxValueParameter${loop.index}"
                                                                    class="order__parameter-max">${parameter.maxValue}</span>
                                                                ${unit}</strong>
                                                        </p>
                                                ...
                                                <%--Image--%>
                                                    <div class="offset-1 col-6">
                                                        <div class="order__guide-parameter">
                                                            <img src="<c:url value="
                                                                assets/img/parameter_guide/${parameter.guideImg}" />"
                                                            alt="">
                                                        </div>
                                                    </div>
                                            </div>
                        ...
                        <div class="order__log">
                            <div class="order__info">
                                <div class="order__media">
                                    ...
                                    <img src="<c:url value=" assets/img/product_img/${firstImage}" />"
                                    alt="${firstImage}"/>
                                </div>
