                                    ...
                                    <div class="row ">
                                        <div class="col-3">
                                            <form action="filterProductBuying" class="form__filter">
                                                ...
                                                <div class="filter__group">
                                                    ...
                                                    <div class="filter__radio-list">
                                                        <c:forEach
                                                            ...
                                                            <label class="filter__radio-item">
                                                                <input name="moneyRange" type="checkbox"
                                                                    class="filter__input filter__radio" hidden="hidden"
                                                ...
                                                <div class="filter__group">
                                                    ...
                                                    <div class="filter__radio-list">
                                                        <c:forEach items="${requestScope.sizeList}" var="item">
                                                            <label class="filter__radio-item">
                                                                <input name="size" value="${item.nameSize}"
                                                                    type="checkbox" class="filter__input filter__radio"
                                                                    hidden="hidden">
                                                                <span class="filter-radio__icon-wrapper">
                                                                    <i class="fa-solid fa-check filter-radio__icon"></i>
                                                                </span>
                                                ...
                                                <button class="filter__submit button--hover button"
                                        ...
                                        <<<<<<< HEAD=======>>>>>>> f41c717c858d51c2af80ad58f5ddb81a8e70cef3
                                            <div class="col-9">
                                                    ...
                                                    <div class="product__list">
                                                        <c:forEach var="item" items="${list}">
                                                            <div class="product__item hvr-grow-shadow">
                                                                ...
                                                                <c:url var="linkProductDetail"
                                                                    value="/showProductDetail">
                                                                    <c:param name="id" value="${item.id}" />
                                                                    <c:param name="ten-sapn-pham"
                                                                        value="${item.name}" />
                                                                </c:url>
                                                ...
                                                <c:if test="${empty list}">
                                                    <p class="product__list--empty">Không có sản phẩm nào ứng với bộ lọc
                                                    </p>
                                                </c:if>
                                            ...
                                            <c:forEach var="pageNumber" begin="1" end="${requestScope.quantityPage}">
                                                ...
                                                <c:choose>
                                                    <c:when test="${pageNumber == requestScope.currentPage}">
                                                        <a class="page page--current"
                                                            href="${linkPaing}">${pageNumber}</a>
                                                    </c:when>
                                                    <c:otherwise>
