            ...
            <div class="row">
                <div class="col-6 ">
                    ...
                    <div id="thumbnail-slider"
                         class="splide custom-thumbnail-slider">
                        <div class="splide__track">
                            <ul class="splide__list">
                                <%
                                    for (Image image :
                ...
                <div class="offset-1 col-5">
                    <div class="product__info">
                        <form action="<c:url value=" AddToCart" />"
                              method="post" id="form__product" class="product__form">
                            <h1 class="product__name" id="product__name">
                                <%=product.getName()%>
                            </h1>
                            <input type="text" hidden="hidden" name="productId"
                                   value="<%=product.getId()%>">

                            <%
                                for (int starA = 1; starA
                            ...
                            <%
                                for (int starB = 1; starB <= 5 -
                                        productFactory.calculateStar(product.getId());
                                     starB++) {
                            %>
                            <i
                                    class="product__star fa-regular fa-star"></i>
                            <%}%>
                            ...
                            <div class="product__price-wrapper">
                                ...
                                <c:choose>
                                    <c:when
                                            test="<%=product.getSalePrice() == 0%>">
                                        <p
                                                class="product__price product__price--sale hvr-grow">
                                                ${originalPrice}</p>
                                    </c:when>
                                    ...
                                    <c:otherwise>
                                        <p
                                                ...
                                                ${originalPrice}</p>
                                        <p
                                                class="product__price product__price--base hvr-bubble-left">
                                                ${salePrice}</p>
                                    </c:otherwise>
                                </c:choose>
                            ...
                            <div class="form__block">
                                ...
                                <div class="form__choose-color">
                                    <c:forEach var="color"
                                               items="${colors}">
                                        <label
                                                class="form__color-check shadow rounded"
                            ...
                            <div class="form__block">
                                ...
                                <div class="form__size-list">
                                    <c:forEach var="size"
                                               items="${sizes}">
                                        <div
                                                class="form__size-item hvr-skew-forward">
                                            <label> <input
                                                    type="radio"
                                                    name="size"
                                                    class="form__radio"
                            ...
                            <a href="<c:url value="
                                                                                    /showProductOrder?id=<%=product.getId()%>"/>"
                               type="submit"
                               class="form__submit
                                                                                    form__submit--order button
                                                                                    text-secondary"
                               data="Đặt may theo số đo">
                            </a>

                            <button type="submit"
                                    class="form__submit form__submit--add button "
                ...
                <div class="col-12 mb-5">
                    ...
                    <div class="product__desc-review">
                        <div
                                class="product__page product__page--clicked hvr-float-shadow">
                            Mô tả
                        </div>
                        <div class="product__page hvr-float-shadow">Đánh giá
                        </div>
                    </div>
                        ...
                        <c:choose>
                            <c:when test="${not empty requestScope.listReview}">
                                <div class="review__list">
                                    <%
                                        for (Review review : (List<Review>)
                                                request.getAttribute("listReview")) {
                                    %>
                                    <% User
                                            user = userFatory.getUserByIdProductDetail(review.getOrderDetailId());%>
                                    <article class="review">
                                        ...
                                        <div class="review__account">
                                            ...
                                            <ul class="review__stars">
                                                ...
                                                %>
                                                <li
                                                        class="review__star review__start--archive">
                                                            <%}%>

                                                    <c:if
                                                            test="<%=review.getRatingStar() < 5%>">
                                                            <%for(int
                                                                                                                    starB=1;
                                                                                                                    starB
                                                                                                                    <=5-
                                                                                                                    review.getRatingStar();starB++){%>
                                                <li
                                                        class="review__star ">
                                                </li>
                                                <%}%>
                            ...
                            <c:otherwise>
                                <p class="review__empty">
                                    Hãy trở thành người đầu tiên đánh giá sản
                                    phẩm.
                                </p>
                            </c:otherwise>
                        </c:choose>
                    ...
                    <div class="product__related">
                        ...
                        <a href="<c:url value="
                           ...
                           class="product__more hvr-forward">Xem thêm
                            <i
                                    class="product__more-icon fa-solid fa-arrow-right"></i></a>
                    </div>

                    <div class="product__list">
                        <%
                            for (Product item : (List<Product>)
                                    request.getAttribute("listProductRelated")) {
                        %>
                        <div class="product__item hvr-grow-shadow">

                            <c:set
                                    value="<%=productFactory.getListImagesByProductId(item.getId())%>"
                                    var="listProductImage"/>

                            <a
                                    href="${pageContext.request.contextPath}/showProductDetail?id=<%=item.getId()%>">
                            ...
                            <div class="product__info">
                                ...
                                <div class="product__review">
                                    <div class="product__review-stars">
                                        <%
                                            for (int starA = 1; starA
                                                    <= productFactory.calculateStar(item.getId());
                                                 starA++) {
                                        %>
                                    ...
                                    <a class="product__review-num"
                                       target="_blank"
                                       href="${linkProductDetail}">
                                        <%=productFactory.getReviewCount(item.getId())%>
                                        nhận xét
                                    </a>
                                </div>
...
<script
        src="https://cdnjs.cloudflare.com/ajax/libs/typeit/5.0.2/typeit.min.js"
