...
import {formatDate, http} from "../base.js";
...
$(document).ready(function () {
    ...
    function fieldData(data) {
        ...
        modal.find("#name").text("");
        modal.find("#color").css("--badge-color", data.colorRequired);
        modal.find("#color-code").text(data.colorRequired);
        modal.find("#size").text(data.sizeRequired);
        modal.find("#price-unit").text("");
        modal.find("#quantity").text(data.quantityRequired);
        loadStars(data.stars);
        modal.find("#date").text(formatDate(data.date));
        modal.find("#description").text(data.feedback);
    }
    function loadStars(stars){
