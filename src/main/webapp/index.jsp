	...
	<main id="main">
		...
		<div class="hero">
			...
			<div class="hero__slogan">
				...
				<a href="productBuying.jsp"
					class="hero__button button button--hover">Bắt đầu đặt may</a>
			</div>
		</div>
					...
					<div class="slider__items">
						<c:forEach items="${requestScope.listSlideShow}" var="slide">
							<img class="slider__item"
								src="./assets/img/slider/${slide.nameImage}">
						</c:forEach>
					</div>
						...
						<div class="product__item">
							<div class="product__content">
								...
								<div class="product__info">
									...
									<span class="product__price"> <fmt:setLocale
											value="vi_VN" /> <c:choose>
											<c:when test="${trendProduct.salePrice == null}">
												<strong class="priority__price"> <fmt:formatNumber
														value="${trendProduct.originalPrice}" type="currency" />
												</strong>
											</c:when>
											<c:otherwise>
												<strong class="sale__price"> <fmt:formatNumber
														value="${trendProduct.salePrice}" type="currency" />
												</strong>
						...
						<div class="product__item">
							<div class="product__content">
								<div class="image--tag">
									...
									<img
										src="./assets/img/product_img/${listNewProductImages.get(0).nameImage}">
									<c:if
								...
								<div class="product__info">
									...
									<span class="product__price"> <fmt:setLocale
											...
											<c:when test="${newProduct.salePrice == null}">
												<strong class="priority__price"> <fmt:formatNumber
														value="${newProduct.originalPrice}" type="currency" />
												</strong>
											</c:when>
											<c:otherwise>
												<strong class="sale__price"> <fmt:formatNumber
														value="${newProduct.salePrice}" type="currency" />
												</strong>
												<s class="original__price"> <fmt:formatNumber
														value="${newProduct.originalPrice}" type="currency" />
												</s>
		...
		<div id="discovery__us--section" class="container-xl">
			<div class="discovery__container">
				<h2 class="section__title">Bạn có thể khám phá được điều gì ở
					chúng tôi?</h2>
		...
		<div class="step__guide--section container-xl">
			<h2 class="section__title">Cách bước để bạn có thể đặt may một
				mẫu đồ</h2>
